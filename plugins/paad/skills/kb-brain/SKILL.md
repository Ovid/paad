...
Positional action, then intuitive values. Prefer the script for deterministic
scaffold/index/check/seal work.
...
Natural language is fine (“record the parser failure”, “close the current
workspace”). If no action can be inferred safely, show the list above and ask.
