...
Dispatch these agents simultaneously using the Agent tool (`subagent_type: paad:paad-analyst`). Each receives: the diff, manifest of files to review, steering file contents, and their specialist focus.
...
After all specialists complete, dispatch a single **Verifier** agent (`subagent_type: paad:paad-analyst`) with all of the following:
