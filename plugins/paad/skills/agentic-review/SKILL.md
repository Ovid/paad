...
After all specialists complete, dispatch a single **Verifier** agent using the Agent tool with `subagent_type: paad:paad-analyst`, passing all of the following:
