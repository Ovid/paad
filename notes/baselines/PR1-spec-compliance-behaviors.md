...
These findings come from non-Spec-Compliance specialists. The PR1 extraction does not touch their content; if they change after extraction, that is unexpected and worth investigating, but they are not part of the Spec Compliance acceptance criteria. The blocks below are copied verbatim from the report file.
