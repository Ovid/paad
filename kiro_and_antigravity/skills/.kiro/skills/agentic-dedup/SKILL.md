...
**On invocation:** announce "Running paad:agentic-dedup v1.24.1" before anything else.
...
Write verified findings to `.reviews/dedup-reviews/<branch-or-scope>-<YYYY-MM-DD-HH-MM-SS>-<short-sha>.md`.
...
- Resolves under `.reviews/dedup-reviews/` — no leading `/`, no
...
5. **Security-disclosure warning.** If any Critical or Important
   ...
   > and will be committed if you `git add .reviews/dedup-reviews/`.
