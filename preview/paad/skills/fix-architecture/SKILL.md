...
**On invocation:** announce "Running paad:fix-architecture v1.30.2-preview" before anything else.
...
- `/fix-architecture` — finds the most recent report in `paad/architecture-reviews/` by date prefix
